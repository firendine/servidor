...
=======
            <div class="cont">
                <a href="/jugador/1">
                <img src="<?=ROOT . DT . IMG?>jug-1.png" class="jug">
                </a>
                <a href="/jugador/2">
                <img src="<?=ROOT . DT . IMG?>jug-2.png" class="jug">
                </a>
                <a href="/jugador/3">
                <img src="<?=ROOT . DT . IMG?>jug-3.png" class="jug">
                </a>
                <a href="/jugador/4">
                <img src="<?=ROOT . DT . IMG?>jug-4.png" class="jug">
>>>>>>> 1er commit
                </a>
            </div>
</body>
